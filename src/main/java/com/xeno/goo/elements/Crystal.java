...
public class Crystal extends AbstractElement {

	public Crystal(Supplier<AbstractGooEffect> effectSupplier, TagKey<EntityType<?>> immunityTag, int debuffDuration, int debuffMaxStacks) {
