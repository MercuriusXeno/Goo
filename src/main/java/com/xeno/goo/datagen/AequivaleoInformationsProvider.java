...
public class AequivaleoInformationsProvider extends ForcedInformationProvider
{
    ...
    public void calculateDataToSave()
    {
        ...
        saveData(Items.CRIMSON_STEM, fungal(16), chromatic(64), vital (16));
        saveData(Items.WARPED_STEM, fungal(16), chromatic(64), vital (16));
        ...
        saveData(Items.STRIPPED_CRIMSON_STEM, fungal(16), chromatic(48));
        saveData(Items.STRIPPED_WARPED_STEM, fungal(16), chromatic(48));
