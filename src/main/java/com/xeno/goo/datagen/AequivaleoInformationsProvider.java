...
public class AequivaleoInformationsProvider extends ForcedInformationProvider
{
    ...
    public void calculateDataToSave()
    {
        ...
        saveData(Items.ACACIA_LOG, floral(32), vital(4));
        saveData(Items.BIRCH_LOG, floral(32), vital(4));
        saveData(Items.DARK_OAK_LOG, floral(32), vital(4));
        saveData(Items.JUNGLE_LOG, floral(32), vital(4));
        saveData(Items.OAK_LOG, floral(32), vital(4));
        saveData(Items.SPRUCE_LOG, floral(32), vital(4));
        saveData(Items.CRIMSON_STEM, fungal(32), chromatic(32), vital (4));
        saveData(Items.WARPED_STEM, fungal(32), chromatic(32), vital (4));
        saveData(Items.STRIPPED_ACACIA_LOG, floral(32));
        saveData(Items.STRIPPED_BIRCH_LOG, floral(32));
        saveData(Items.STRIPPED_DARK_OAK_LOG, floral(32));
        saveData(Items.STRIPPED_JUNGLE_LOG, floral(32));
        saveData(Items.STRIPPED_OAK_LOG, floral(32));
        saveData(Items.STRIPPED_SPRUCE_LOG, floral(32));
        saveData(Items.STRIPPED_CRIMSON_STEM, fungal(32), chromatic(32));
        saveData(Items.STRIPPED_WARPED_STEM, fungal(32), chromatic(32));
        saveData(Items.ACACIA_SAPLING, floral(16), vital(16));
        saveData(Items.BIRCH_SAPLING, floral(16), vital(16));
        saveData(Items.DARK_OAK_SAPLING, floral(16), vital(16));
        saveData(Items.JUNGLE_SAPLING, floral(16), vital(16));
        saveData(Items.OAK_SAPLING, floral(16), vital(16));
        saveData(Items.SPRUCE_SAPLING, floral(16), vital(16));
        ...
        saveData(Items.DEAD_BUSH, floral(5), decay(5));
        saveData(Items.FERN, floral(5), vital(1));
        saveData(Items.GRASS, floral(5), vital(1));
        saveData(Items.CRIMSON_ROOTS, fungal(5), vital(1));
        saveData(Items.NETHER_SPROUTS, fungal(5), vital(1));
        saveData(Items.WARPED_ROOTS, fungal(5), vital(1));
        saveData(Items.LARGE_FERN, floral(10), vital(2));
        saveData(Items.TALL_GRASS, floral(10), vital(2));
        saveData(Items.BLACKSTONE, earthen(32));
        saveData(Items.COBBLESTONE, earthen(32));
        saveData(Items.INFESTED_COBBLESTONE, earthen(32));
        saveData(Items.MOSSY_COBBLESTONE, earthen(32), floral(4));
        saveData(Items.DIRT, earthen(32));
        saveData(Items.FLINT, earthen(32));
        saveData(Items.GRAVEL, earthen(32));
        saveData(Items.PODZOL, earthen(32), fungal(4));
        saveData(Items.RED_SAND, earthen(32));
        saveData(Items.SAND, earthen(32));
        saveData(Items.GLASS, earthen(24), crystal(3));
        saveData(Items.APPLE, floral(15), vital(1));
        saveData(Items.BAMBOO, floral(2));
        saveData(Items.BASALT, earthen(32), molten(15));
        ...
        saveData(Items.BONE, faunal(15), chromatic(144), decay(15));
        saveData(Items.BROWN_MUSHROOM, fungal(15), vital(1));
        saveData(Items.BROWN_MUSHROOM_BLOCK, fungal(5));
        saveData(Items.CACTUS, floral(32), chromatic(48), vital (1));
        saveData(Items.CARROT, floral(15), vital(1));
        ...
        saveData(Items.CLAY_BALL, earthen(16), aquatic(4));
        saveData(Items.BRICK, earthen(16));
        ...
        saveData(Items.GILDED_BLACKSTONE, metal(240), regal(240), earthen(32));
        saveData(Items.GLOWSTONE_DUST, radiant(10));
        saveData(Items.BELL, earthen(120), regal(216), metal(180), floral(128));
        saveData(Items.GRASS_BLOCK, earthen(32), floral(5));
        ...
        saveData(Items.KELP, floral(5), vital(1));
        saveData(Items.LILY_PAD, floral(5), vital(1));
        saveData(Items.MAGMA_BLOCK, molten(64), earthen(32), decay(32));
        saveData(Items.MELON_SLICE, floral(15), vital(1));
        saveData(Items.MUSHROOM_STEM, fungal(5));
        saveData(Items.MUTTON, faunal(15), vital(1));
        saveData(Items.MYCELIUM, earthen(32), fungal(30));
        saveData(Items.NETHER_WART, weird(1), fungal(5));
        saveData(Items.WARPED_WART_BLOCK, weird(9), fungal(45));
        saveData(Items.NETHERRACK, earthen(32), molten(5), decay(5));
        saveData(Items.OBSIDIAN, molten(32), earthen(32), weird(16), crystal(16));
        ...
        saveData(Items.SLIME_BALL, slime(32));
        saveData(Items.SNOWBALL, snow(15));
        saveData(Items.SOUL_SAND, earthen(32), vital(15), decay(60));
        saveData(Items.SOUL_SOIL, earthen(32), vital(15), decay(60));
        ...
        saveData(Items.WARPED_NYLIUM, earthen(32), molten(60), fungal(15));
        ...
        saveData(Items.DIAMOND_ORE, crystal(240), earthen(32), primordial(6), forbidden(1));
        saveData(Items.DIAMOND, crystal(240), primordial(6));
        saveData(Items.EMERALD_ORE, regal(120), crystal(120), earthen(32), forbidden(1));
        saveData(Items.EMERALD, regal(120), crystal(120));
        saveData(Items.NETHER_GOLD_ORE, metal(36), regal(72), earthen(32), forbidden(1));
        saveData(Items.GOLD_ORE, metal(36), regal(72), earthen(32), forbidden(1));
        saveData(Items.GOLD_INGOT, metal(36), regal(72));
        saveData(Items.IRON_ORE, metal(72), earthen(32), forbidden(1));
        saveData(Items.IRON_INGOT, metal(72));
        saveData(Items.REDSTONE_ORE, logic(32), earthen(32), forbidden(1));
        saveData(Items.REDSTONE, logic(32));
        saveData(Items.LAPIS_ORE, weird(4), chromatic(48), earthen(32), crystal(30), forbidden(1));
