...
public class LockedInformationsProvider extends LockedInformationProvider
{
    ...
    {
        saveData(Items.ACACIA_LEAVES, floral(60), vital(60));
        saveData(Items.BIRCH_LEAVES, floral(60), vital(60));
        saveData(Items.DARK_OAK_LEAVES, floral(60), vital(60));
        saveData(Items.JUNGLE_LEAVES, floral(60), vital(60));
        saveData(Items.OAK_LEAVES, floral(60), vital(60));
        saveData(Items.SPRUCE_LEAVES, floral(60), vital(60));
        saveData(Items.ACACIA_LOG, floral(960), vital(60));
        saveData(Items.BIRCH_LOG, floral(960), vital(60));
        saveData(Items.DARK_OAK_LOG, floral(960), vital(60));
        saveData(Items.JUNGLE_LOG, floral(960), vital(60));
        saveData(Items.OAK_LOG, floral(960), vital(60));
        saveData(Items.SPRUCE_LOG, floral(960), vital(60));
        saveData(Items.CRIMSON_STEM, fungal(960), chromatic(60), vital (60));
        saveData(Items.WARPED_STEM, fungal(960), chromatic(60), vital (60));
        ...
        saveData(Items.ACACIA_SAPLING, floral(960), vital(60));
        saveData(Items.BIRCH_SAPLING, floral(960), vital(60));
        saveData(Items.DARK_OAK_SAPLING, floral(960), vital(60));
        saveData(Items.JUNGLE_SAPLING, floral(960), vital(60));
        saveData(Items.OAK_SAPLING, floral(960), vital(60));
        saveData(Items.SPRUCE_SAPLING, floral(960), vital(60));
        saveData(Items.ALLIUM, floral(60), chromatic(240), vital(60));
        saveData(Items.AZURE_BLUET, floral(60), chromatic(240), vital(60));
        saveData(Items.BLUE_ORCHID, floral(60), chromatic(240), vital(60));
        saveData(Items.COCOA_BEANS, floral(60), chromatic(240), vital(60));
        saveData(Items.CORNFLOWER, floral(60), chromatic(240), vital(60));
        saveData(Items.DANDELION, floral(60), chromatic(240), vital(60));
        saveData(Items.LILY_OF_THE_VALLEY, floral(60), chromatic(240), vital(60));
        saveData(Items.ORANGE_TULIP, floral(60), chromatic(240), vital(60));
        saveData(Items.OXEYE_DAISY, floral(60), chromatic(240), vital(60));
        saveData(Items.PINK_TULIP, floral(60), chromatic(240), vital(60));
        saveData(Items.POPPY, floral(60), chromatic(240), vital(60));
        saveData(Items.RED_TULIP, floral(60), chromatic(240), vital(60));
        saveData(Items.WHITE_TULIP, floral(60), chromatic(240), vital(60));
        saveData(Items.LILAC, floral(120), chromatic(480), vital(120));
        saveData(Items.PEONY, floral(120), chromatic(480), vital(120));
        saveData(Items.ROSE_BUSH, floral(120), chromatic(480), vital(120));
        saveData(Items.SUNFLOWER, floral(120), chromatic(480), vital(120));
        ...
        saveData(Items.BRAIN_CORAL, faunal(60), vital(60));
        saveData(Items.BUBBLE_CORAL, faunal(60), vital(60));
        ...
        saveData(Items.FIRE_CORAL, faunal(60), vital(60));
        saveData(Items.HORN_CORAL, faunal(60), vital(60));
        saveData(Items.TUBE_CORAL, faunal(60), vital(60));
        saveData(Items.BRAIN_CORAL_BLOCK, faunal(480), vital(480));
        saveData(Items.BUBBLE_CORAL_BLOCK, faunal(480), vital(480));
        ...
        saveData(Items.FIRE_CORAL_BLOCK, faunal(480), vital(480));
        saveData(Items.HORN_CORAL_BLOCK, faunal(480), vital(480));
        saveData(Items.TUBE_CORAL_BLOCK, faunal(480), vital(480));
        saveData(Items.BRAIN_CORAL_FAN, faunal(60), vital(60));
        saveData(Items.BUBBLE_CORAL_FAN, faunal(60), vital(60));
        ...
        saveData(Items.FIRE_CORAL_FAN, faunal(60), vital(60));
        saveData(Items.HORN_CORAL_FAN, faunal(60), vital(60));
        saveData(Items.TUBE_CORAL_FAN, faunal(60), vital(60));
        saveData(Items.DEAD_BUSH, floral(120));
        saveData(Items.FERN, floral(120), vital(60));
        saveData(Items.GRASS, floral(120), vital(60));
        saveData(Items.CRIMSON_ROOTS, fungal(120), vital(60));
        saveData(Items.NETHER_SPROUTS, fungal(120), vital(60));
        saveData(Items.WARPED_ROOTS, fungal(120), vital(60));
        saveData(Items.LARGE_FERN, floral(240), vital(120));
        saveData(Items.TALL_GRASS, floral(240), vital(120));
        ...
        saveData(Items.BLAZE_ROD, molten(120), energetic(60), vital(60));
        saveData(Items.BONE, faunal(180), chromatic(360), vital(180), decay(60));
        saveData(Items.BROWN_MUSHROOM, fungal(60), vital(60));
        saveData(Items.BROWN_MUSHROOM_BLOCK, fungal(960));
        saveData(Items.CACTUS, floral(960), chromatic(240), vital (60));
        saveData(Items.CARROT, floral(60), vital(60));
        saveData(Items.CARVED_PUMPKIN, floral(60), weird(60));
        saveData(Items.CHARCOAL, molten(96), floral(96));
        saveData(Items.CHICKEN, faunal(60), vital(60));
        saveData(Items.CHORUS_FLOWER, floral(240), weird(240), vital(60));
        saveData(Items.CHORUS_FRUIT, floral(60), weird(60), vital(60));
        saveData(Items.CLAY_BALL, earthen(240));
        saveData(Items.COAL, molten(96), earthen(72));
        saveData(Items.COBWEB, faunal(120));
        saveData(Items.COD, faunal(60), vital(60));
        saveData(Items.CRIMSON_NYLIUM, earthen(480d), fungal(480d), chromatic(60));
        saveData(Items.CRIMSON_FUNGUS, fungal(120));
        saveData(Items.CRYING_OBSIDIAN, weird(60), obsidian(960));
        saveData(Items.DIAMOND, crystal(120));
        saveData(Items.EGG, faunal(60), vital(60));
        saveData(Items.EMERALD, regal(60), crystal(60));
        saveData(Items.END_STONE, earthen(720), weird(240), vital(60));
        ...
        saveData(Items.LILY_PAD, floral(60), aquatic(60), vital(60));
        saveData(Items.MELON_SLICE, floral(60), vital(60));
        saveData(Items.MUSHROOM_STEM, fungal(960));
        saveData(Items.MUTTON, faunal(60), vital(60));
        ...
        saveData(Items.PHANTOM_MEMBRANE, decay(60), vital(60), weird(60));
        saveData(Items.POISONOUS_POTATO, floral(60), weird(60), vital(60));
        saveData(Items.PORKCHOP, faunal(60), vital(60));
        saveData(Items.POTATO, floral(60), vital(60));
        ...
        saveData(Items.SWEET_BERRIES, floral(60), vital(60));
        saveData(Items.TROPICAL_FISH, faunal(60), vital(60));
        saveData(Items.TURTLE_EGG, faunal(60), vital(180), weird(60));
        saveData(Items.TWISTING_VINES, fungal(60));
        saveData(Items.VINE, floral(60));
        ...
        saveData(Items.WET_SPONGE, aquatic(60), weird(60), faunal(120), vital(720));
