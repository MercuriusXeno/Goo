...
public class LockedInformationsProvider extends LockedInformationProvider
{
    ...
    public void calculateDataToSave()
    {
        ...
        saveData(Items.CHORUS_FLOWER, floral(60), weird(240), vital(1));
        saveData(Items.CHORUS_FRUIT, floral(30), weird(60), vital(1));
        ...
        saveData(Items.GHAST_TEAR, weird(60), crystal(24));
        ...
        saveData(Items.POISONOUS_POTATO, floral(15), weird(60));
        ...
        saveData(Items.SHROOMLIGHT, weird(120), fungal(60));
