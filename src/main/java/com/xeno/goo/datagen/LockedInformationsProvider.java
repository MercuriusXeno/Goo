...
public class LockedInformationsProvider extends LockedInformationProvider
{
    ...
    public void calculateDataToSave()
    {
        ...
        saveData(Items.ACACIA_LOG, floral(120), vital(6));
        saveData(Items.BIRCH_LOG, floral(120), vital(6));
        saveData(Items.DARK_OAK_LOG, floral(120), vital(6));
        saveData(Items.JUNGLE_LOG, floral(120), vital(6));
        saveData(Items.OAK_LOG, floral(120), vital(6));
        saveData(Items.SPRUCE_LOG, floral(120), vital(6));
        saveData(Items.CRIMSON_STEM, fungal(15), chromatic(120), vital (6));
        saveData(Items.WARPED_STEM, fungal(15), chromatic(120), vital (6));
        saveData(Items.STRIPPED_ACACIA_LOG, floral(120));
        saveData(Items.STRIPPED_BIRCH_LOG, floral(120));
        saveData(Items.STRIPPED_DARK_OAK_LOG, floral(120));
        saveData(Items.STRIPPED_JUNGLE_LOG, floral(120));
        saveData(Items.STRIPPED_OAK_LOG, floral(120));
        saveData(Items.STRIPPED_SPRUCE_LOG, floral(120));
        saveData(Items.STRIPPED_CRIMSON_STEM, fungal(15), chromatic(120));
        saveData(Items.STRIPPED_WARPED_STEM, fungal(15), chromatic(120));
        ...
        saveData(Items.CHARCOAL, molten(108), floral(36), energetic(36));
        saveData(Items.CHICKEN, faunal(60), vital(1));
        saveData(Items.CHORUS_FLOWER, floral(60), weird(12), vital(1));
        saveData(Items.CHORUS_FRUIT, floral(30), weird(6), vital(1));
        saveData(Items.CLAY_BALL, earthen(60));
        saveData(Items.COAL, molten(108), earthen(18), energetic(36));
        ...
        saveData(Items.NETHER_WART, weird(3), fungal(5));
        saveData(Items.WARPED_WART_BLOCK, weird(27), fungal(45));
        saveData(Items.NETHERITE_SCRAP, metal(960), obsidian(120));
        saveData(Items.NETHERRACK, earthen(180), molten(15));
        ...
        saveData(Items.PRISMARINE_CRYSTALS, aquatic(36), crystal(2), weird(6), energetic(72));
        saveData(Items.PRISMARINE_SHARD, aquatic(36), crystal(1), weird(12));
        saveData(Items.PUFFERFISH, faunal(60), weird(6));
        saveData(Items.PUMPKIN, floral(60));
        saveData(Items.QUARTZ, earthen(60), crystal (1));
        saveData(Items.RABBIT, faunal(60), vital(1));
        saveData(Items.RABBIT_FOOT, faunal(60), weird(15));
        ...
        saveData(Items.SPIDER_EYE, faunal(60), weird(15));
        ...
        saveData(Items.TURTLE_EGG, faunal(60), vital(30), weird(60));
        ...
        saveData(Items.WET_SPONGE, aquatic(720), weird(6), faunal(120), vital(15));
