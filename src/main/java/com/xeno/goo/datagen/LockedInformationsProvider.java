...
public class LockedInformationsProvider extends LockedInformationProvider
{
    ...
    public void calculateDataToSave()
    {
        ...
        saveData(Items.SPRUCE_LEAVES, floral(5), vital(8));
        saveData(Items.ACACIA_LOG, floral(128), vital(8));
        saveData(Items.BIRCH_LOG, floral(128), vital(8));
        saveData(Items.DARK_OAK_LOG, floral(128), vital(8));
        saveData(Items.JUNGLE_LOG, floral(128), vital(8));
        saveData(Items.OAK_LOG, floral(128), vital(8));
        saveData(Items.SPRUCE_LOG, floral(128), vital(8));
        saveData(Items.CRIMSON_STEM, fungal(16), chromatic(128), vital (8));
        saveData(Items.WARPED_STEM, fungal(16), chromatic(128), vital (8));
