...
public class TroughFluidHandler implements IFluidHandler
{
    private final TroughTile parent;
    public TroughFluidHandler(TroughTile t) {
        parent = t;
    }
    ...
    public int getTankCapacity(int tank) {
        return tank == 0 ? GooMod.config.troughCapacity() : 0;
    }
