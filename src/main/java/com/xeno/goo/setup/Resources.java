...
public class Resources
{
    ...
    {
        public static final ResourceLocation AQUATIC_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/aquatic.png");
        public static final ResourceLocation CHROMATIC_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/chromatic.png");
        public static final ResourceLocation CRYSTAL_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/crystal.png");
        public static final ResourceLocation DECAY_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/decay.png");
        public static final ResourceLocation EARTHEN_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/earthen.png");
        public static final ResourceLocation ENERGETIC_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/energetic.png");
        public static final ResourceLocation FAUNAL_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/faunal.png");
        public static final ResourceLocation FLORAL_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/floral.png");
        public static final ResourceLocation FUNGAL_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/fungal.png");
        public static final ResourceLocation HONEY_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/honey.png");
        ...
        public static final ResourceLocation SLIME_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/slime.png");
        public static final ResourceLocation SNOW_GOO = new ResourceLocation(GooMod.MOD_ID, "textures/icons/snow.png");
