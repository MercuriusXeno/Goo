...
public class SliverModel implements IModelGeometry<SliverModel> {
    ...
    public SliverModel(Fluid fluid, boolean applyFluidLuminosity)
    {
        this.fluid = fluid;
     ...
     */
    public SliverModel withFluid(Fluid newFluid)
    {
        return new SliverModel(newFluid);
    }
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        ItemMultiLayerBakedModel.Builder builder = ItemMultiLayerBakedModel.builder(owner, particleSprite, new SliverModel.SliverContainedOverrideList(overrides, bakery, owner, this), transformMap);
    ...
    public enum Loader implements IModelLoader<SliverModel>
    {
        INSTANCE;
        ...
        @Override
        public SliverModel read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
        {
            ...
            return new SliverModel(fluid, applyFluidLuminosity);
        }
    }

    private static final class SliverContainedOverrideList extends ItemOverrideList
    {
        ...
        private final SliverModel parent;

        private SliverContainedOverrideList(ItemOverrideList nested, ModelBakery bakery, IModelConfiguration owner, SliverModel parent)
        {
            this.nested = nested;
            this.bakery = bakery;
            this.owner = owner;
