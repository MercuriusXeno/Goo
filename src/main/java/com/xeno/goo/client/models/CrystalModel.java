...
public class CrystalModel implements IModelGeometry<CrystalModel> {
    ...
    @Deprecated
    public CrystalModel(Fluid fluid)
    {
        this(fluid, true);
    }

    public CrystalModel(Fluid fluid, boolean applyFluidLuminosity)
    {
        this.fluid = fluid;
     ...
     */
    public CrystalModel withFluid(Fluid newFluid)
    {
        return new CrystalModel(newFluid);
    }
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        ItemMultiLayerBakedModel.Builder builder = ItemMultiLayerBakedModel.builder(owner, particleSprite, new CrystalModel.CrystalContainedOverrideList(overrides, bakery, owner, this), transformMap);
    ...
    public enum Loader implements IModelLoader<CrystalModel>
    {
        INSTANCE;
        ...
        public CrystalModel read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
        {
            ...
            return new CrystalModel(fluid, applyFluidLuminosity);
        }
    }

    private static final class CrystalContainedOverrideList extends ItemOverrideList
    {
        ...
        private final CrystalModel parent;

        private CrystalContainedOverrideList(ItemOverrideList nested, ModelBakery bakery, IModelConfiguration owner, CrystalModel parent)
        {
            this.nested = nested;
            this.bakery = bakery;
            this.owner = owner;
