...
public class ChunkModel implements IModelGeometry<ChunkModel> {
    ...
    @Deprecated
    public ChunkModel(Fluid fluid)
    {
        this(fluid, true);
    }

    public ChunkModel(Fluid fluid, boolean applyFluidLuminosity)
    {
        this.fluid = fluid;
     ...
     */
    public ChunkModel withFluid(Fluid newFluid)
    {
        return new ChunkModel(newFluid);
    }
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        ItemMultiLayerBakedModel.Builder builder = ItemMultiLayerBakedModel.builder(owner, particleSprite, new ChunkModel.ChunkContainedOverrideList(overrides, bakery, owner, this), transformMap);
    ...
    public enum Loader implements IModelLoader<ChunkModel>
    {
        INSTANCE;
        ...
        @Override
        public ChunkModel read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
        {
            ...
            return new ChunkModel(fluid, applyFluidLuminosity);
        }
    }

    private static final class ChunkContainedOverrideList extends ItemOverrideList
    {
        ...
        private final ChunkModel parent;

        private ChunkContainedOverrideList(ItemOverrideList nested, ModelBakery bakery, IModelConfiguration owner, ChunkModel parent)
        {
            this.nested = nested;
            this.bakery = bakery;
            this.owner = owner;
