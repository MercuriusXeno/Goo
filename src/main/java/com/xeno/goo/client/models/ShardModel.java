...
public class ShardModel implements IModelGeometry<ShardModel> {
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        ItemMultiLayerBakedModel.Builder builder = ItemMultiLayerBakedModel.builder(owner, particleSprite, new ShardModel.ShardContainedOverrideList(overrides, bakery, owner, this), transformMap);
