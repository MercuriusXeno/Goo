...
public class SlabModel implements IModelGeometry<SlabModel> {
    ...
    @Deprecated
    public SlabModel(Fluid fluid)
    {
        this(fluid, true);
    }

    public SlabModel(Fluid fluid, boolean applyFluidLuminosity)
    {
        this.fluid = fluid;
     ...
     */
    public SlabModel withFluid(Fluid newFluid)
    {
        return new SlabModel(newFluid);
    }
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        ItemMultiLayerBakedModel.Builder builder = ItemMultiLayerBakedModel.builder(owner, particleSprite, new SlabModel.SlabContainedOverrideList(overrides, bakery, owner, this), transformMap);
    ...
    public enum Loader implements IModelLoader<SlabModel>
    {
        INSTANCE;
        ...
        @Override
        public SlabModel read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
        {
            ...
            return new SlabModel(fluid, applyFluidLuminosity);
        }
    }

    private static final class SlabContainedOverrideList extends ItemOverrideList
    {
        ...
        private final SlabModel parent;

        private SlabContainedOverrideList(ItemOverrideList nested, ModelBakery bakery, IModelConfiguration owner, SlabModel parent)
        {
            this.nested = nested;
            this.bakery = bakery;
            this.owner = owner;
