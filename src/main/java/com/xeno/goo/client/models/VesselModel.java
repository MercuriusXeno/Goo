...
public final class VesselModel implements IModelGeometry<VesselModel>
{
    ...
    @Deprecated
    public VesselModel(Fluid fluid)
    {
        this(fluid, true);
    }

    public VesselModel(Fluid fluid, boolean applyFluidLuminosity)
    {
        this.fluid = fluid;
     ...
     */
    public VesselModel withFluid(Fluid newFluid)
    {
        return new VesselModel(newFluid);
    }
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform modelTransform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        ItemMultiLayerBakedModel.Builder builder = ItemMultiLayerBakedModel.builder(owner, particleSprite, new VesselContainedOverridesList(overrides, bakery, owner, this), transformMap);
...
//                }
    ...
    public enum Loader implements IModelLoader<VesselModel>
    {
        INSTANCE;
        ...
        @Override
        public VesselModel read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
        {
            if (!modelContents.has("fluid"))
                throw new RuntimeException("Vessel model requires 'fluid' value.");
            ...
            return new VesselModel(fluid, applyFluidLuminosity);
        }
    }

    private static final class VesselContainedOverridesList extends ItemOverrideList
    {
        ...
        private final VesselModel parent;

        private VesselContainedOverridesList(ItemOverrideList nested, ModelBakery bakery, IModelConfiguration owner, VesselModel parent)
        {
            this.nested = nested;
            this.bakery = bakery;
            this.owner = owner;
        ...
        public IBakedModel getOverrideModel(IBakedModel originalModel, ItemStack stack, ClientWorld world, LivingEntity entity)
        {
            ...
            return FluidUtil.getFluidContained(stack)
                    .map(fluidStack -> {
                        ...
                        {
                            VesselModel unbaked = this.parent.withFluid(fluid);
                            IBakedModel bakedModel = unbaked.bake(owner, bakery, ModelLoader.defaultTextureGetter(), ModelRotation.X0_Y0, this, new ResourceLocation(GooMod.MOD_ID, "vessel_override"));
