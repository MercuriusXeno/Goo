...
public abstract class HolderModelLoader implements IModelLoader<DynamicHolderModel>
{
    @Override
    ...
    @Override
    public DynamicHolderModel read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
    {
        if (!modelContents.has("fluid"))
            throw new RuntimeException("Holder model requires 'fluid' value.");
        ...
        return new DynamicHolderModel(fluid, flip, tint, coverIsMask, applyFluidLuminosity, holderName());
    }
