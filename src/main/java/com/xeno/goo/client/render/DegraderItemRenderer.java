...
public class DegraderItemRenderer extends ItemStackTileEntityRenderer
{
    public static final DegraderItemRenderer instance = new DegraderItemRenderer();
    public DegraderItemRenderer() {
        super();
    }
