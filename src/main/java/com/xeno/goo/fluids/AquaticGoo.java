...
public abstract class AquaticGoo extends GooBase
{
    private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(
            Registry.AQUATIC_GOO, Registry.AQUATIC_GOO_FLOWING,
            FluidAttributes.builder(
                    Resources.GooTextures.Still.AQUATIC_GOO,
                    Resources.GooTextures.Flowing.AQUATIC_GOO)
                .translationKey("fluid.goo.aquatic_goo"))
            .bucket(() -> Items.AIR)
            .block(Registry.AQUATIC_GOO_BLOCK)
            .slopeFindDistance(3)
    ...
    @Override
    public Fluid getStillFluid() { return Registry.AQUATIC_GOO.get(); }

    @Override
    public Fluid getFlowingFluid()
    {
        return Registry.AQUATIC_GOO_FLOWING.get();
    }

    @Override
    protected BlockState getBlockState(FluidState state)
    {
        return Registry.AQUATIC_GOO_BLOCK.get().getDefaultState().with(FlowingFluidBlock.LEVEL, getLevelFromState(state));
    }

    public static class Flowing extends AquaticGoo {
        public Flowing()
        {
            super();
        }
    ...
    public static class Source extends AquaticGoo {
        public Source()
        {
            super();
        }
