...
public abstract class SnowGoo extends GooBase
{
    private static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(
            Registry.SNOW_GOO, Registry.SNOW_GOO_FLOWING,
            FluidAttributes.builder(
                    Resources.GooTextures.Still.SNOW_GOO,
                    Resources.GooTextures.Flowing.SNOW_GOO)
                    .translationKey("fluid.goo.snow_goo"))
            .bucket(() -> Items.AIR)
            .block(Registry.SNOW_GOO_BLOCK)
            .slopeFindDistance(3)
    ...
    @Override
    public Fluid getStillFluid() { return Registry.SNOW_GOO.get(); }

    @Override
    public Fluid getFlowingFluid() { return Registry.SNOW_GOO_FLOWING.get(); }

    @Override
    protected BlockState getBlockState(FluidState state)
    {
        return Registry.SNOW_GOO_BLOCK.get().getDefaultState().with(FlowingFluidBlock.LEVEL, getLevelFromState(state));
    }

    public static class Flowing extends SnowGoo {
    ...
    public static class Source extends SnowGoo {
