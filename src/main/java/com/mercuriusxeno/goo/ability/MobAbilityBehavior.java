 ...
 */
public final class MobAbilityBehavior implements ChainBehavior {
     ...
     */
    public MobAbilityBehavior(String handlerName) {
    ...
    public static ChainBehavior fromEntry(BehaviorEntry entry, AbilityDefinition def) {
        return new MobAbilityBehavior(entry.params().getOrDefault(PARAM_HANDLER, NO_HANDLER));
    }
