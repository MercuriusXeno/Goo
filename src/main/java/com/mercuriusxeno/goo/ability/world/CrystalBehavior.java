...
/**
 * Crystal goo: shard cloud that shreds moving entities. Stitched merge
 * of the prior CrystalEffect (instant world hit, places a cloud via
 * EffectBlockPlacement) and CrystalBehavior (chain marker fuse,
 * persistent shred-on-move zone). Sneaking negates damage; sprinting
 * doubles hit frequency.
 */
public final class CrystalBehavior implements WorldEffect, ChainBehavior {
