...
public final class GooStreamRenderer {
    ...
    private static void renderColoredFaceNorth(PoseStack.Pose pose, VertexConsumer c, int light,
        ...
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x1, y1, z, u0, v0, 0, 0, -1);
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x1, y0, z, u0, v1, 0, 0, -1);
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x0, y0, z, u1, v1, 0, 0, -1);
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x0, y1, z, u1, v0, 0, 0, -1);
    }
    ...
    private static void renderColoredFaceWest(PoseStack.Pose pose, VertexConsumer c, int light,
            ...
            float u0, float u1, float v0, float v1) {
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x, y1, z0, u1, v0, -1, 0, 0);
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x, y0, z0, u1, v1, -1, 0, 0);
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x, y0, z1, u0, v1, -1, 0, 0);
        GooRenderUtil.vertexColored(pose, c, light, STREAM_COLOR, x, y1, z1, u0, v0, -1, 0, 0);
    }
