...
public class BucketGooFluidHandler extends ItemAccessResourceHandler<FluidResource> {
    ...
    protected ItemResource update(ItemResource item, int oldAmount,
        ...
        GooContents updated = replaceType(readContents(item), type, newAmount);
     ...
     */
    private GooContents replaceType(GooContents contents, GooType type, int amount) {
     ...
     * @return the updated item resource
     */
    private ItemResource applyContents(ItemResource item, GooContents contents) {
