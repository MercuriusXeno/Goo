...
/**
 * Static shape-rotation utilities for the plexer and reactor block.
 * Rotates the south-facing base VoxelShape into all four horizontal facings.
 */
public final class CutawayShapeHelper {
     ...
     */
    public static Map<Direction, VoxelShape> buildShapes(VoxelShape southShape) {
     ...
     */
    public static VoxelShape rotateShapeCw(VoxelShape shape, int steps) {
        if (steps == 0) {
            return shape;
        }
     ...
     */
    public static VoxelShape rotateBoxCw(double x1, double y1, double z1,
     ...
     */
    public static void rotateCoordsOnce(double... c) {
