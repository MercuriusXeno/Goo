...
class NetherExecutorTest {
    ...
    void mergeValue_emptyAccumulator_plantsValue() {
        ...
        assertEquals(1152L, totals.get(GooType.ROCK));
        assertEquals(500L, totals.get(GooType.NETHER));
    ...
    void mergeValue_sameType_sums() {
        ...
        assertEquals(2152L, totals.get(GooType.ROCK));
    }
    ...
    void mergeValue_differentTypes_independent() {
        ...
        assertEquals(1000L, totals.get(GooType.ROCK));
        assertEquals(500L, totals.get(GooType.FROST));
    }
    ...
    void mergeValue_repeatedGrass_accumulates() {
        ...
        assertEquals(1152L * blockCount, totals.get(GooType.ROCK));
    ...
    void mergeValue_multiType_distributes() {
        ...
        assertEquals(800L, totals.get(GooType.ROCK));
        assertEquals(200L, totals.get(GooType.BLAZE));
        assertEquals(100L, totals.get(GooType.NETHER));
    }
    ...
    void mergeValue_mixedAccumulation_producesCorrectTotals() {
        ...
        assertEquals(2152L, totals.get(GooType.ROCK));
        assertEquals(1000L, totals.get(GooType.FROST));
        assertEquals(500L, totals.get(GooType.BLAZE));
        assertTrue(totals.get(GooType.NETHER) == null || totals.get(GooType.NETHER) == 0L);
    }
}
